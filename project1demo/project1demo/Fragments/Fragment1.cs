...
namespace project1demo.Fragments
{
    public class Fragment1 : SupportFragment
    {
        ...
        {
            var values = GetRandomSubList(festival.FestivalStrings, 30);
            ...
            recyclerView.SetItemClickListener((rv, position, view) =>
            {
                ...
                Intent intent = new Intent(context, typeof(FestivalDetailActivity));
                intent.PutExtra(FestivalDetailActivity.EXTRA_NAME, values[position]);
        ...
        public class SimpleStringRecyclerViewAdapter : RecyclerView.Adapter
        {
            ...
            public override async void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
            {
                ...
                int drawableID = festival.RandomFestivalDrawable;
                ...
                else
                {
                    ...
                    options.InSampleSize = festival.CalculateInSampleSize(options, 100, 100);
        ...
        public class SimpleViewHolder : RecyclerView.ViewHolder
        {
            ...
            {
                mView = view;
                mImageView = view.FindViewById<ImageView>(Resource.Id.avator);
