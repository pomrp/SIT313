...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("project1demo.Fragments.AttachStateChangeListener, project1demo", AttachStateChangeListener.class, __md_methods);
	}
	...
	public AttachStateChangeListener ()
	{
		...
		if (getClass () == AttachStateChangeListener.class)
			mono.android.TypeManager.Activate ("project1demo.Fragments.AttachStateChangeListener, project1demo", "", this, new java.lang.Object[] {  });
	}
